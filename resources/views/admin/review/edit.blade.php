                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control"
                                                       placeholder="Enter ..." value="{{$review->title}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <!-- text input -->
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="names" class="form-control"
                                                       placeholder="Enter ..." value="{{$review->names}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div style="height: 200px">
                                                    <img id="blah1" alt="insert an image" width="auto" height="200px" src="{{asset('storage/' . $review->img)}}">
                                                </div>
                                                <br>
